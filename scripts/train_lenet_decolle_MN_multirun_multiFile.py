...
def main():
    ...
    args = parse_args('parameters/params_MN_10cl_incr_cs200_ov0_AllSubj.yml')
    ...
    path_to_save = 'C:/Users/stanzarella/OneDrive - Fondazione Istituto Italiano Tecnologia/Documents/IIT_Project/2.Codes/FromLiterature/decolle-public/scripts/DECOLLEallSubj/'
    typeData = 'Plateau'
    for cv in range(0, CV):
        ...
        if not args.no_train:
            ...
            for e in range(starting_epoch , params['num_epochs'] ):
                ...
                # if (e % params['test_interval']) == 0 and e!=0:
                #     struct = {'e':e, 'test_acc':test_acc, 'test_loss':test_loss, 'act_rate':act_rate, 'total_loss':total_loss }
                # else:
                #     struct = {'e': e, 'act_rate': act_rate,
                #               'total_loss': total_loss}
                # spio.savemat(
                #     path_to_save + 'resultsDECOLLEallSub_' + str(e) + '_'  + typeData + '.mat',
                #     struct)
