...
from decolle.lenet_redecolle import LenetREDECOLLE, RecLIFLayer, LIFLayer
...
def main(params_file, name = None, save=False, extra_params={}):
    ...
    net = LenetREDECOLLE( out_channels=params['out_channels'],
                        ...
                        lif_layer_type = [RecLIFLayer]*len(params['Mhid'])+[LIFLayer],
...
if __name__ == "__main__":
    main(params_file = 'parameters/params_bptt_nmnist_mlp_rec.yml', save=True, name='rec_test')
